...
int main(void)
{
  ...
  17:	68 46 08 00 00       	push   $0x846
  1c:	6a 01                	push   $0x1
  1e:	e8 bd 04 00 00       	call   4e0 <printf>
	// int par_pid = getpid();
	int cid = fork();
  23:	e8 12 03 00 00       	call   33a <fork>

	if(cid==0){
  28:	83 c4 10             	add    $0x10,%esp
  2b:	85 c0                	test   %eax,%eax
  2d:	75 67                	jne    96 <main+0x96>
		// This is child
		char *msg1 = (char *)malloc(MSGSIZE);
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	6a 08                	push   $0x8
  34:	e8 07 07 00 00       	call   740 <malloc>
  ...
  43:	53                   	push   %ebx
  44:	e8 c1 03 00 00       	call   40a <recv>
		while(stat==-1){
  ...
  54:	6a 08                	push   $0x8
  56:	e8 e5 06 00 00       	call   740 <malloc>
		msg = "bithere";
		send(getpid(),*((int*)msg1),(void *)msg);	
  5b:	8b 1b                	mov    (%ebx),%ebx
  5d:	e8 60 03 00 00       	call   3c2 <getpid>
  62:	83 c4 0c             	add    $0xc,%esp
  65:	68 4a 08 00 00       	push   $0x84a
  6a:	53                   	push   %ebx
  6b:	50                   	push   %eax
  6c:	e8 91 03 00 00       	call   402 <send>
		printf(1,"1 CHILD: msg sent is: %s \n", msg );
  71:	83 c4 0c             	add    $0xc,%esp
  74:	68 4a 08 00 00       	push   $0x84a
  79:	68 52 08 00 00       	push   $0x852
  7e:	6a 01                	push   $0x1
  80:	e8 5b 04 00 00       	call   4e0 <printf>
		
		free(msg);
  85:	c7 04 24 4a 08 00 00 	movl   $0x84a,(%esp)
  8c:	e8 1f 06 00 00       	call   6b0 <free>
		exit();
  91:	e8 ac 02 00 00       	call   342 <exit>
  96:	89 c3                	mov    %eax,%ebx
		...
		int par_pid[2];
		par_pid[0] = getpid();
  98:	e8 25 03 00 00       	call   3c2 <getpid>
		send(par_pid[0],cid,(void *)par_pid);
  9d:	52                   	push   %edx
  9e:	8d 55 f0             	lea    -0x10(%ebp),%edx
		par_pid[0] = getpid();
  ...
  a5:	53                   	push   %ebx
  a6:	50                   	push   %eax
  a7:	e8 56 03 00 00       	call   402 <send>

		char *msg = (char *)malloc(MSGSIZE);
  ac:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  b3:	e8 88 06 00 00       	call   740 <malloc>
  ...
  c3:	53                   	push   %ebx
  c4:	e8 41 03 00 00       	call   40a <recv>
		while(stat==-1){
  c9:	83 c4 10             	add    $0x10,%esp
  cc:	83 f8 ff             	cmp    $0xffffffff,%eax
  cf:	74 ef                	je     c0 <main+0xc0>
		}
		printf(1,"2 PARENT: msg recv is: %s \n", msg );
  d1:	50                   	push   %eax
  d2:	53                   	push   %ebx
  d3:	68 6d 08 00 00       	push   $0x86d
  d8:	6a 01                	push   $0x1
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
  }while((x /= base) != 0);
 ...
 4b0:	e8 ad fe ff ff       	call   362 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 520:	e8 3d fe ff ff       	call   362 <write>
 ...
 598:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 59a:	e8 c3 fd ff ff       	call   362 <write>
  for(i = 0; fmt[i]; i++){
 ...
 633:	57                   	push   %edi
 634:	53                   	push   %ebx
 635:	e8 28 fd ff ff       	call   362 <write>
        while(*s != 0){
 ...
 687:	e8 d6 fc ff ff       	call   362 <write>
        ap++;
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 89 08 00 00       	mov    $0x889,%ebx
        while(*s != 0){
