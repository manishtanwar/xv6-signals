...
0000037a <sig_send>:
SYSCALL(sig_send)
 37a:	b8 1e 00 00 00       	mov    $0x1e,%eax
 37f:	cd 40                	int    $0x40
 381:	c3                   	ret    

00000382 <sig_pause>:
SYSCALL(sig_pause)
 382:	b8 1f 00 00 00       	mov    $0x1f,%eax
 387:	cd 40                	int    $0x40
 389:	c3                   	ret    

0000038a <sig_ret>:
SYSCALL(sig_ret)
 38a:	b8 20 00 00 00       	mov    $0x20,%eax
 38f:	cd 40                	int    $0x40
 391:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb ab 07 00 00       	mov    $0x7ab,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 58 0a 00 00       	mov    %eax,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 58 0a 00 00    	mov    0xa58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 58 0a 00 00    	cmp    %eax,0xa58
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 767:	0a 00 00 
 76a:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 5c 0a 00 00       	mov    $0xa5c,%eax
 779:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 780:	00 00 00 
