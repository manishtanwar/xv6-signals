...
000003b2 <sig_pause>:
SYSCALL(sig_pause)
 3b2:	b8 1f 00 00 00       	mov    $0x1f,%eax
 3b7:	cd 40                	int    $0x40
 3b9:	c3                   	ret    

000003ba <sig_ret>:
SYSCALL(sig_ret)
 3ba:	b8 20 00 00 00       	mov    $0x20,%eax
 3bf:	cd 40                	int    $0x40
 3c1:	c3                   	ret    
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 407:	f7 f1                	div    %ecx
 409:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb f5 07 00 00       	mov    $0x7f5,%ebx
        while(*s != 0){
 ...
 641:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 ac 0a 00 00       	mov    %eax,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 ...
 789:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 797:	0a 00 00 
 79a:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 7a9:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 7b0:	00 00 00 
