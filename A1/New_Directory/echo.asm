...
main(int argc, char *argv[])
{
  ...
  28:	68 b8 07 00 00       	push   $0x7b8
  2d:	50                   	push   %eax
  2e:	68 ba 07 00 00       	push   $0x7ba
  33:	6a 01                	push   $0x1
  35:	e8 26 04 00 00       	call   460 <printf>
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	8b 43 fc             	mov    -0x4(%ebx),%eax
  43:	39 f3                	cmp    %esi,%ebx
  45:	75 e1                	jne    28 <main+0x28>
  47:	68 bf 07 00 00       	push   $0x7bf
  4c:	50                   	push   %eax
  4d:	68 ba 07 00 00       	push   $0x7ba
  52:	6a 01                	push   $0x1
...
000003aa <sig_ret>:
SYSCALL(sig_ret)
 3aa:	b8 20 00 00 00       	mov    $0x20,%eax
 3af:	cd 40                	int    $0x40
 3b1:	c3                   	ret    
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 430:	e8 ad fe ff ff       	call   2e2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a0:	e8 3d fe ff ff       	call   2e2 <write>
 ...
 518:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 51a:	e8 c3 fd ff ff       	call   2e2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b3:	57                   	push   %edi
 5b4:	53                   	push   %ebx
 5b5:	e8 28 fd ff ff       	call   2e2 <write>
        while(*s != 0){
 ...
 607:	e8 d6 fc ff ff       	call   2e2 <write>
        ap++;
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb c1 07 00 00       	mov    $0x7c1,%ebx
        while(*s != 0){
 ...
 631:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 74 0a 00 00       	mov    %eax,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 787:	0a 00 00 
 78a:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 78 0a 00 00       	mov    $0xa78,%eax
 799:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 7a0:	00 00 00 
