...
main(int argc, char *argv[])
{
  ...
  toggle();
  11:	e8 24 03 00 00       	call   33a <toggle>
  // fork(); 
  int fd = open("arr", 0);
  16:	83 ec 08             	sub    $0x8,%esp
  19:	6a 00                	push   $0x0
  1b:	68 88 07 00 00       	push   $0x788
  20:	e8 ad 02 00 00       	call   2d2 <open>
  close(fd);
  25:	89 04 24             	mov    %eax,(%esp)
  28:	e8 8d 02 00 00       	call   2ba <close>
  print_count();
  2d:	e8 00 03 00 00       	call   332 <print_count>
  exit();
...
0000037a <sig_ret>:
SYSCALL(sig_ret)
 37a:	b8 20 00 00 00       	mov    $0x20,%eax
 37f:	cd 40                	int    $0x40
 381:	c3                   	ret    
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
  }while((x /= base) != 0);
 ...
 400:	e8 ad fe ff ff       	call   2b2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 3d fe ff ff       	call   2b2 <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 c3 fd ff ff       	call   2b2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 28 fd ff ff       	call   2b2 <write>
        while(*s != 0){
 ...
 5d7:	e8 d6 fc ff ff       	call   2b2 <write>
        ap++;
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 8c 07 00 00       	mov    $0x78c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 38 0a 00 00       	mov    0xa38,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 38 0a 00 00       	mov    %eax,0xa38
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 38 0a 00 00    	mov    0xa38,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 38 0a 00 00    	mov    0xa38,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 38 0a 00 00    	mov    %edx,0xa38
}
 ...
 757:	0a 00 00 
 75a:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 3c 0a 00 00       	mov    $0xa3c,%eax
 769:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 770:	00 00 00 
