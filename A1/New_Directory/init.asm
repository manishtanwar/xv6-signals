...
0000041a <sig_send>:
SYSCALL(sig_send)
 41a:	b8 1e 00 00 00       	mov    $0x1e,%eax
 41f:	cd 40                	int    $0x40
 421:	c3                   	ret    

00000422 <sig_pause>:
SYSCALL(sig_pause)
 422:	b8 1f 00 00 00       	mov    $0x1f,%eax
 427:	cd 40                	int    $0x40
 429:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 88 08 00 00       	mov    $0x888,%ebx
        while(*s != 0){
 ...
 6b1:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 40 0b 00 00       	mov    %eax,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 40 0b 00 00 44 	movl   $0xb44,0xb40
 807:	0b 00 00 
 80a:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 44 0b 00 00       	mov    $0xb44,%eax
 819:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 820:	00 00 00 
