...
0000065a <sig_send>:
SYSCALL(sig_send)
 65a:	b8 1e 00 00 00       	mov    $0x1e,%eax
 65f:	cd 40                	int    $0x40
 661:	c3                   	ret    

00000662 <sig_pause>:
SYSCALL(sig_pause)
 662:	b8 1f 00 00 00       	mov    $0x1f,%eax
 667:	cd 40                	int    $0x40
 669:	c3                   	ret    

0000066a <sig_ret>:
SYSCALL(sig_ret)
 66a:	b8 20 00 00 00       	mov    $0x20,%eax
 66f:	cd 40                	int    $0x40
 671:	c3                   	ret    
...
free(void *ap)
{
 ...
 8f1:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 92d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 92f:	a3 60 0e 00 00       	mov    %eax,0xe60
}
 934:	5b                   	pop    %ebx
 935:	5e                   	pop    %esi
 936:	5f                   	pop    %edi
 ...
 946:	72 ce                	jb     916 <free+0x26>
{
 ...
 967:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 96a:	a3 60 0e 00 00       	mov    %eax,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 15 60 0e 00 00    	mov    0xe60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9cf:	73 47                	jae    a18 <malloc+0x98>
    ...
    if(p == freep)
 9d1:	39 05 60 0e 00 00    	cmp    %eax,0xe60
 ...
 9f6:	e8 f5 fe ff ff       	call   8f0 <free>
  return freep;
 9fb:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 a47:	0e 00 00 
 a4a:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 a51:	0e 00 00 
    base.s.size = 0;
 a54:	b8 64 0e 00 00       	mov    $0xe64,%eax
 a59:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 a60:	00 00 00 
