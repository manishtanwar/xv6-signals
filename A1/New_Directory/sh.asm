...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d e2 18 00 00 20 	cmpb   $0x20,0x18e2
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 e0 18 00 00       	push   $0x18e0
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d e0 18 00 00 63 	cmpb   $0x63,0x18e0
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d e1 18 00 00 64 	cmpb   $0x64,0x18e1
  ...
  exit();
      ...
      be:	68 e0 18 00 00       	push   $0x18e0
      c3:	e8 78 0a 00 00       	call   b40 <strlen>
      if(chdir(buf+3) < 0)
      c8:	c7 04 24 e3 18 00 00 	movl   $0x18e3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      cf:	c6 80 df 18 00 00 00 	movb   $0x0,0x18df(%eax)
      if(chdir(buf+3) < 0)
      ...
      e6:	50                   	push   %eax
      e7:	68 e3 18 00 00       	push   $0x18e3
      ec:	68 b1 12 00 00       	push   $0x12b1
      f1:	6a 02                	push   $0x2
      f3:	e8 b8 0d 00 00       	call   eb0 <printf>
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 08 12 00 00       	push   $0x1208
     113:	6a 02                	push   $0x2
     115:	e8 96 0d 00 00       	call   eb0 <printf>
  memset(buf, 0, nbuf);
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 a5 12 00 00       	push   $0x12a5
     15e:	6a 02                	push   $0x2
     160:	e8 4b 0d 00 00       	call   eb0 <printf>
  exit();
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 c0 12 00 00 	jmp    *0x12c0(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 12 12 00 00       	push   $0x1212
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 22 12 00 00       	push   $0x1222
     202:	6a 02                	push   $0x2
     204:	e8 a7 0c 00 00       	call   eb0 <printf>
      exit();
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 0b 12 00 00       	push   $0x120b
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 32 12 00 00       	push   $0x1232
     ...
     2d8:	68 37 12 00 00       	push   $0x1237
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 bc 18 00 00       	push   $0x18bc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 bc 18 00 00       	push   $0x18bc
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 b4 18 00 00       	push   $0x18b4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 bc 18 00 00       	push   $0x18bc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 bc 18 00 00       	push   $0x18bc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 59 12 00 00       	push   $0x1259
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 3c 12 00 00       	push   $0x123c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 5c 12 00 00       	push   $0x125c
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 73 12 00 00       	push   $0x1273
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 65 12 00 00       	push   $0x1265
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 5e 12 00 00       	push   $0x125e
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 78 12 00 00       	push   $0x1278
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 7a 12 00 00       	push   $0x127a
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 76 12 00 00       	push   $0x1276
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 5c 12 00 00       	push   $0x125c
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 98 12 00 00       	push   $0x1298
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 d8 12 00 00 	jmp    *0x12d8(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 21 12 00 00       	push   $0x1221
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 9a 12 00 00       	push   $0x129a
     aa6:	6a 02                	push   $0x2
     aa8:	e8 03 04 00 00       	call   eb0 <printf>
    panic("syntax");
     aad:	c7 04 24 5e 12 00 00 	movl   $0x125e,(%esp)
...
00000dea <sig_send>:
SYSCALL(sig_send)
     dea:	b8 1e 00 00 00       	mov    $0x1e,%eax
     def:	cd 40                	int    $0x40
     df1:	c3                   	ret    

00000df2 <sig_pause>:
SYSCALL(sig_pause)
     df2:	b8 1f 00 00 00       	mov    $0x1f,%eax
     df7:	cd 40                	int    $0x40
     df9:	c3                   	ret    

00000dfa <sig_ret>:
SYSCALL(sig_ret)
     dfa:	b8 20 00 00 00       	mov    $0x20,%eax
     dff:	cd 40                	int    $0x40
     e01:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     e19:	85 d2                	test   %edx,%edx
{
     e1b:	89 45 c0             	mov    %eax,-0x40(%ebp)
    neg = 1;
    x = -xx;
     e1e:	89 d0                	mov    %edx,%eax
  if(sgn && xx < 0){
     e20:	79 76                	jns    e98 <printint+0x88>
     e22:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
     e26:	74 70                	je     e98 <printint+0x88>
    x = -xx;
     e28:	f7 d8                	neg    %eax
    neg = 1;
     e2a:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
     e31:	31 f6                	xor    %esi,%esi
     e33:	8d 5d d7             	lea    -0x29(%ebp),%ebx
     e36:	eb 0a                	jmp    e42 <printint+0x32>
     e38:	90                   	nop
     e39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  do{
    buf[i++] = digits[x % base];
     e40:	89 fe                	mov    %edi,%esi
     e42:	31 d2                	xor    %edx,%edx
     e44:	8d 7e 01             	lea    0x1(%esi),%edi
     e47:	f7 f1                	div    %ecx
     e49:	0f b6 92 f8 12 00 00 	movzbl 0x12f8(%edx),%edx
  }while((x /= base) != 0);
     e50:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
     e52:	88 14 3b             	mov    %dl,(%ebx,%edi,1)
  }while((x /= base) != 0);
     e55:	75 e9                	jne    e40 <printint+0x30>
  if(neg)
     e57:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     e5a:	85 c0                	test   %eax,%eax
     e5c:	74 08                	je     e66 <printint+0x56>
    buf[i++] = '-';
     e5e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
     e63:	8d 7e 02             	lea    0x2(%esi),%edi
     e66:	8d 74 3d d7          	lea    -0x29(%ebp,%edi,1),%esi
     e6a:	8b 7d c0             	mov    -0x40(%ebp),%edi
     e6d:	8d 76 00             	lea    0x0(%esi),%esi
     e70:	0f b6 06             	movzbl (%esi),%eax
  write(fd, &c, 1);
     e73:	83 ec 04             	sub    $0x4,%esp
     e76:	83 ee 01             	sub    $0x1,%esi
     e79:	6a 01                	push   $0x1
     e7b:	53                   	push   %ebx
     e7c:	57                   	push   %edi
     e7d:	88 45 d7             	mov    %al,-0x29(%ebp)
     e80:	e8 ad fe ff ff       	call   d32 <write>

  while(--i >= 0)
     e85:	83 c4 10             	add    $0x10,%esp
     e88:	39 de                	cmp    %ebx,%esi
     e8a:	75 e4                	jne    e70 <printint+0x60>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
     e98:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
     e9f:	eb 90                	jmp    e31 <printint+0x21>
     ea1:	eb 0d                	jmp    eb0 <printf>
     ea3:	90                   	nop
     ea4:	90                   	nop
     ea5:	90                   	nop
     ea6:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ec1:	0f 84 b3 00 00 00    	je     f7a <printf+0xca>
  ap = (uint*)(void*)&fmt + 1;
     ec7:	8d 45 10             	lea    0x10(%ebp),%eax
     eca:	83 c6 01             	add    $0x1,%esi
  state = 0;
     ecd:	31 ff                	xor    %edi,%edi
  ap = (uint*)(void*)&fmt + 1;
     ecf:	89 45 d4             	mov    %eax,-0x2c(%ebp)
     ed2:	eb 2f                	jmp    f03 <printf+0x53>
     ed4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
     ed8:	83 f8 25             	cmp    $0x25,%eax
     edb:	0f 84 a7 00 00 00    	je     f88 <printf+0xd8>
  write(fd, &c, 1);
     ee1:	8d 45 e2             	lea    -0x1e(%ebp),%eax
     ee4:	83 ec 04             	sub    $0x4,%esp
     ee7:	88 5d e2             	mov    %bl,-0x1e(%ebp)
     eea:	6a 01                	push   $0x1
     eec:	50                   	push   %eax
     eed:	ff 75 08             	pushl  0x8(%ebp)
     ef0:	e8 3d fe ff ff       	call   d32 <write>
     ef5:	83 c4 10             	add    $0x10,%esp
     ef8:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
     efb:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
     eff:	84 db                	test   %bl,%bl
     f01:	74 77                	je     f7a <printf+0xca>
    if(state == 0){
     f03:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
     f05:	0f be cb             	movsbl %bl,%ecx
     f08:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
     f0b:	74 cb                	je     ed8 <printf+0x28>
        state = '%';
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
     f0d:	83 ff 25             	cmp    $0x25,%edi
     f10:	75 e6                	jne    ef8 <printf+0x48>
      if(c == 'd'){
     f12:	83 f8 64             	cmp    $0x64,%eax
     f15:	0f 84 05 01 00 00    	je     1020 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     f1b:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
     f21:	83 f9 70             	cmp    $0x70,%ecx
     f24:	74 72                	je     f98 <printf+0xe8>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     f26:	83 f8 73             	cmp    $0x73,%eax
     f29:	0f 84 99 00 00 00    	je     fc8 <printf+0x118>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f2f:	83 f8 63             	cmp    $0x63,%eax
     f32:	0f 84 08 01 00 00    	je     1040 <printf+0x190>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     f38:	83 f8 25             	cmp    $0x25,%eax
     f3b:	0f 84 ef 00 00 00    	je     1030 <printf+0x180>
  write(fd, &c, 1);
     f41:	8d 45 e7             	lea    -0x19(%ebp),%eax
     f44:	83 ec 04             	sub    $0x4,%esp
     f47:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
     f4b:	6a 01                	push   $0x1
     f4d:	50                   	push   %eax
     f4e:	ff 75 08             	pushl  0x8(%ebp)
     f51:	e8 dc fd ff ff       	call   d32 <write>
     f56:	83 c4 0c             	add    $0xc,%esp
     f59:	8d 45 e6             	lea    -0x1a(%ebp),%eax
     f5c:	88 5d e6             	mov    %bl,-0x1a(%ebp)
     f5f:	6a 01                	push   $0x1
     f61:	50                   	push   %eax
     f62:	ff 75 08             	pushl  0x8(%ebp)
     f65:	83 c6 01             	add    $0x1,%esi
      } else {
      ...
      state = 0;
     f68:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
     f6a:	e8 c3 fd ff ff       	call   d32 <write>
  for(i = 0; fmt[i]; i++){
     f6f:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
  write(fd, &c, 1);
     f73:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
     f76:	84 db                	test   %bl,%bl
     f78:	75 89                	jne    f03 <printf+0x53>
    }
  }
}
     ...
     f82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        state = '%';
     f88:	bf 25 00 00 00       	mov    $0x25,%edi
     f8d:	e9 66 ff ff ff       	jmp    ef8 <printf+0x48>
     f92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
     f98:	83 ec 0c             	sub    $0xc,%esp
     f9b:	b9 10 00 00 00       	mov    $0x10,%ecx
     fa0:	6a 00                	push   $0x0
     fa2:	8b 7d d4             	mov    -0x2c(%ebp),%edi
     fa5:	8b 45 08             	mov    0x8(%ebp),%eax
     fa8:	8b 17                	mov    (%edi),%edx
     faa:	e8 61 fe ff ff       	call   e10 <printint>
        ap++;
     faf:	89 f8                	mov    %edi,%eax
     fb1:	83 c4 10             	add    $0x10,%esp
      state = 0;
     fb4:	31 ff                	xor    %edi,%edi
        ap++;
     fb6:	83 c0 04             	add    $0x4,%eax
     fb9:	89 45 d4             	mov    %eax,-0x2c(%ebp)
     fbc:	e9 37 ff ff ff       	jmp    ef8 <printf+0x48>
     fc1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
     fc8:	8b 45 d4             	mov    -0x2c(%ebp),%eax
     fcb:	8b 08                	mov    (%eax),%ecx
        ap++;
     fcd:	83 c0 04             	add    $0x4,%eax
     fd0:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
     fd3:	85 c9                	test   %ecx,%ecx
     fd5:	0f 84 8e 00 00 00    	je     1069 <printf+0x1b9>
        while(*s != 0){
     fdb:	0f b6 01             	movzbl (%ecx),%eax
      state = 0;
     fde:	31 ff                	xor    %edi,%edi
        s = (char*)*ap;
     fe0:	89 cb                	mov    %ecx,%ebx
        while(*s != 0){
     fe2:	84 c0                	test   %al,%al
     fe4:	0f 84 0e ff ff ff    	je     ef8 <printf+0x48>
     fea:	89 75 d0             	mov    %esi,-0x30(%ebp)
     fed:	89 de                	mov    %ebx,%esi
     fef:	8b 5d 08             	mov    0x8(%ebp),%ebx
     ff2:	8d 7d e3             	lea    -0x1d(%ebp),%edi
     ff5:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
     ff8:	83 ec 04             	sub    $0x4,%esp
          s++;
     ffb:	83 c6 01             	add    $0x1,%esi
     ffe:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    1001:	6a 01                	push   $0x1
    1003:	57                   	push   %edi
    1004:	53                   	push   %ebx
    1005:	e8 28 fd ff ff       	call   d32 <write>
        while(*s != 0){
    100a:	0f b6 06             	movzbl (%esi),%eax
    100d:	83 c4 10             	add    $0x10,%esp
    1010:	84 c0                	test   %al,%al
    1012:	75 e4                	jne    ff8 <printf+0x148>
    1014:	8b 75 d0             	mov    -0x30(%ebp),%esi
      state = 0;
    1017:	31 ff                	xor    %edi,%edi
    1019:	e9 da fe ff ff       	jmp    ef8 <printf+0x48>
    101e:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 10, 1);
    1020:	83 ec 0c             	sub    $0xc,%esp
    1023:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1028:	6a 01                	push   $0x1
    102a:	e9 73 ff ff ff       	jmp    fa2 <printf+0xf2>
    102f:	90                   	nop
  write(fd, &c, 1);
    ...
    1039:	6a 01                	push   $0x1
    103b:	e9 21 ff ff ff       	jmp    f61 <printf+0xb1>
        putc(fd, *ap);
    1040:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  write(fd, &c, 1);
    1043:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    1046:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    1048:	6a 01                	push   $0x1
        ap++;
    104a:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    104d:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    1050:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    1053:	50                   	push   %eax
    1054:	ff 75 08             	pushl  0x8(%ebp)
    1057:	e8 d6 fc ff ff       	call   d32 <write>
        ap++;
    105c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    105f:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1062:	31 ff                	xor    %edi,%edi
    1064:	e9 8f fe ff ff       	jmp    ef8 <printf+0x48>
          s = "(null)";
    1069:	bb f0 12 00 00       	mov    $0x12f0,%ebx
        while(*s != 0){
    106e:	b8 28 00 00 00       	mov    $0x28,%eax
    1073:	e9 72 ff ff ff       	jmp    fea <printf+0x13a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1081:	a1 44 19 00 00       	mov    0x1944,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1098:	39 c8                	cmp    %ecx,%eax
    109a:	8b 10                	mov    (%eax),%edx
    109c:	73 32                	jae    10d0 <free+0x50>
    109e:	39 d1                	cmp    %edx,%ecx
    10a0:	72 04                	jb     10a6 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10a2:	39 d0                	cmp    %edx,%eax
    10a4:	72 32                	jb     10d8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    10a6:	8b 73 fc             	mov    -0x4(%ebx),%esi
    10a9:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    10ac:	39 fa                	cmp    %edi,%edx
    10ae:	74 30                	je     10e0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    10b0:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    10b3:	8b 50 04             	mov    0x4(%eax),%edx
    10b6:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    10b9:	39 f1                	cmp    %esi,%ecx
    10bb:	74 3a                	je     10f7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    10bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
    10bf:	a3 44 19 00 00       	mov    %eax,0x1944
}
    10c4:	5b                   	pop    %ebx
    10c5:	5e                   	pop    %esi
    10c6:	5f                   	pop    %edi
    ...
    10d2:	72 04                	jb     10d8 <free+0x58>
    10d4:	39 d1                	cmp    %edx,%ecx
    10d6:	72 ce                	jb     10a6 <free+0x26>
{
    10d8:	89 d0                	mov    %edx,%eax
    10da:	eb bc                	jmp    1098 <free+0x18>
  ...
  if(p + p->s.size == bp){
    ...
    10f5:	75 c6                	jne    10bd <free+0x3d>
    p->s.size += bp->s.size;
    10f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    10fa:	a3 44 19 00 00       	mov    %eax,0x1944
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    111c:	8b 15 44 19 00 00    	mov    0x1944,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    112d:	0f 84 9d 00 00 00    	je     11d0 <malloc+0xc0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    113a:	76 6c                	jbe    11a8 <malloc+0x98>
    113c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    1142:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1147:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    114a:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    1151:	eb 0e                	jmp    1161 <malloc+0x51>
    1153:	90                   	nop
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    115d:	39 f9                	cmp    %edi,%ecx
    115f:	73 47                	jae    11a8 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1161:	39 05 44 19 00 00    	cmp    %eax,0x1944
    1167:	89 c2                	mov    %eax,%edx
    1169:	75 ed                	jne    1158 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    116b:	83 ec 0c             	sub    $0xc,%esp
    116e:	56                   	push   %esi
    116f:	e8 26 fc ff ff       	call   d9a <sbrk>
  if(p == (char*)-1)
    1174:	83 c4 10             	add    $0x10,%esp
    1177:	83 f8 ff             	cmp    $0xffffffff,%eax
    117a:	74 1c                	je     1198 <malloc+0x88>
  hp->s.size = nu;
    117c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    117f:	83 ec 0c             	sub    $0xc,%esp
    1182:	83 c0 08             	add    $0x8,%eax
    1185:	50                   	push   %eax
    1186:	e8 f5 fe ff ff       	call   1080 <free>
  return freep;
    118b:	8b 15 44 19 00 00    	mov    0x1944,%edx
      if((p = morecore(nunits)) == 0)
    1191:	83 c4 10             	add    $0x10,%esp
    1194:	85 d2                	test   %edx,%edx
    1196:	75 c0                	jne    1158 <malloc+0x48>
        return 0;
  }
}
    ...
    11aa:	74 54                	je     1200 <malloc+0xf0>
        p->s.size -= nunits;
    11ac:	29 f9                	sub    %edi,%ecx
    11ae:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    11b1:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    11b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    ...
    11d7:	19 00 00 
    11da:	c7 05 48 19 00 00 48 	movl   $0x1948,0x1948
    11e1:	19 00 00 
    base.s.size = 0;
    11e4:	b8 48 19 00 00       	mov    $0x1948,%eax
    11e9:	c7 05 4c 19 00 00 00 	movl   $0x0,0x194c
    11f0:	00 00 00 
    11f3:	e9 44 ff ff ff       	jmp    113c <malloc+0x2c>
    11f8:	90                   	nop
    11f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        prevp->s.ptr = p->s.ptr;
    1200:	8b 08                	mov    (%eax),%ecx
    1202:	89 0a                	mov    %ecx,(%edx)
    1204:	eb b1                	jmp    11b7 <malloc+0xa7>
